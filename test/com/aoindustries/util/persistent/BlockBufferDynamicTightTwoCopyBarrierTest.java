 ...
 */
public class BlockBufferDynamicTightTwoCopyBarrierTest extends BlockBufferTestParent {

    public static Test suite() {
        TestSuite suite = new TestSuite(BlockBufferDynamicTightTwoCopyBarrierTest.class);
        return suite;
    }

    public BlockBufferDynamicTightTwoCopyBarrierTest(String testName) {
        super(testName);
    }
