 ...
 */
public class BlockBufferDynamicBalancedTest extends BlockBufferTestParent {

    public static Test suite() {
        TestSuite suite = new TestSuite(BlockBufferDynamicBalancedTest.class);
        return suite;
    }

    public BlockBufferDynamicBalancedTest(String testName) {
        super(testName);
    }
    ...
    public PersistentBlockBuffer getBlockBuffer(PersistentBuffer pbuffer) throws IOException {
        return new DynamicPersistentBlockBuffer(pbuffer, DynamicPersistentBlockBuffer.FreeSpacePolicy.BALANCED);
    }
