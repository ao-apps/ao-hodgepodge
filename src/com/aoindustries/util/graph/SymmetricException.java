 ...
 */
public class SymmetricException extends GraphException {

    // TODO: private static final long serialVersionUID = 7431301822226465307L;

    private static String getMessage(
        SymmetricDirectedGraphVertex<?,?> vertex,
        SymmetricDirectedGraphVertex<?,?> connected
    ) {
        return
    ...
    private final SymmetricDirectedGraphVertex<?,?> vertex;
    private final SymmetricDirectedGraphVertex<?,?> connected;
     ...
     */
    public SymmetricDirectedGraphVertex<?,?> getVertex() {
        return vertex;
    }
     ...
     */
    public SymmetricDirectedGraphVertex<?,?> getConnected() {
        return connected;
    }
}
