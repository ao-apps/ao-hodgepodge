		...
		implements LongList, RandomAccess, Cloneable, java.io.Serializable
{
	...
	public boolean contains(Number elem) {
		if (elem == null) return false;
		return contains(elem.longValue());
	}
	...
	public int lastIndexOf(Number elem) {
		if (elem == null) return -1;
		return lastIndexOf(elem.longValue());
	}
	...
	public Long get(int index) {
		...
		return Long.valueOf(elementData[index]);
	}
	...
	public Long set(int index, Long element) {
		return Long.valueOf(set(index,element.longValue()));
	}
	...
	public Long remove(int index) {
		return Long.valueOf(removeAtIndex(index));
	}
	...
	public boolean removeByValue(Number o) {
		if (o != null) return removeByValue(o.longValue());
		return false;
	}
	...
	public boolean addAll(Collection<? extends Long> c) {
		...
		while(iter.hasNext()) elementData[size++]=iter.next().longValue();
		return numNew != 0;
	}
