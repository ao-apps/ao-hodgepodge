...
public class LocalizedSQLException extends SQLException {
    ...
    public LocalizedSQLException(ApplicationResourcesAccessor accessor, Locale userLocale, String key) {
        super(accessor.getMessage(Locale.getDefault(), key));
        this.localizedMessage = accessor.getMessage(userLocale, key);
    }

    public LocalizedSQLException(ApplicationResourcesAccessor accessor, Locale userLocale, String key, Object... args) {
        super(accessor.getMessage(Locale.getDefault(), key, args));
        this.localizedMessage = accessor.getMessage(userLocale, key, args);
    }

    public LocalizedSQLException(Throwable cause, ApplicationResourcesAccessor accessor, Locale userLocale, String key) {
        super(accessor.getMessage(Locale.getDefault(), key));
        initCause(cause);
        this.localizedMessage = accessor.getMessage(userLocale, key);
    }

    public LocalizedSQLException(Throwable cause, ApplicationResourcesAccessor accessor, Locale userLocale, String key, Object... args) {
        super(accessor.getMessage(Locale.getDefault(), key, args));
        initCause(cause);
        this.localizedMessage = accessor.getMessage(userLocale, key, args);
    }
