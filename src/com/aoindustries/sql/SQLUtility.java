...
public class SQLUtility {
    ...
    public static String escapeSQL(String S) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "escapeSQL(String)", null);
        try {
            int i;
    ...
    public static void escapeSQL(String S, StringBuilder B) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "escapeSQL(String,StringBuilder)", null);
        try {
            int i;
    ...
    public static String encodeString(String S) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "encodeString(String)", null);
        try {
    ...
    public static String decodeString(String S) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "decodeString(String)", null);
        try {
            if(S==null) return null;
    ...
    public static String getDate(long time) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDate(long)", null);
        try {
    ...
    public static java.sql.Date getDate(String s) throws IllegalArgumentException {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDate(String)", null);
        try {
    ...
    public static java.sql.Date getDateTime(String s) throws IllegalArgumentException {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDateTime(String)", null);
        try {
    ...
    public static String getDateTime(long time) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDateTime(long)", null);
        try {
    ...
    public static String getDecimal(int pennies) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDecimal(int)", null);
        try {
    ...
    public static String getDecimal(long pennies) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getDecimal(long)", null);
        try {
            StringBuilder SB=new StringBuilder(10);
            if(pennies<0) {
                SB.append('-');
    ...
    public static String getMilliDecimal(int millis) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getMilliDecimal(int)", null);
        try {
            StringBuilder SB=new StringBuilder(10);
            if(millis<0) {
                SB.append('-');
    ...
    public static int getMillis(String decimal) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getMillis(String)", null);
        try {
    ...
    public static int getPennies(String decimal) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getPennies(String)", null);
        try {
            // Get the sign first, treat as negative, then apply the sign
            boolean isNegative;
            if(decimal.length()>0 && decimal.charAt(0)=='-') {
    ...
    public static long getPenniesLong(String decimal) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "getPenniesLong(String)", null);
        try {
            // Get the sign first, treat as negative, then apply the sign
            boolean isNegative;
            if(decimal.length()>0 && decimal.charAt(0)=='-') {
    ...
    public static int negIntIfEmpty(String s) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "negIntIfEmpty(String)", null);
        try {
            s = nullIfEmpty(s);
    ...
    public static long negLongIfEmpty(String s) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "negLongIfEmpty(String)", null);
        try {
            s = nullIfEmpty(s);
    ...
    public static String nullIfEmpty(String S) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "nullIfEmpty(String)", null);
        try {
    ...
    public static void printResultSetHTMLTable(ResultSet results, ChainWriter out, String title, boolean wordWrap) throws SQLException {
        Profiler.startProfile(Profiler.IO, SQLUtility.class, "printResultSetHTMLTable(ResultSet,ChainWriter,String,boolean)", null);
        try {
    ...
    public static void printStackTraces(SQLException err) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "printStackTraces(SQLException)", null);
        try {
    ...
    public static void printStackTraces(SQLException err, PrintStream out) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "printStackTraces(SQLException,PrintStream)", null);
        try {
    ...
    public static void printStackTraces(SQLException err, PrintWriter out) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "printStackTraces(SQLException,PrintWriter)", null);
        try {
            ErrorPrinter.printStackTraces(err, out);
        } finally {
            Profiler.endProfile(Profiler.FAST);
    ...
    public static void printTable(Object[] titles, Object[] values, PrintWriter out, boolean isInteractive, boolean[] alignRights) {
        Profiler.startProfile(Profiler.IO, SQLUtility.class, "printTable(Object[],Object[],PrintWriter,boolean,boolean[])", null);
        try {
            if(isInteractive) {
    ...
    public static void printTable(Object[] titles, Collection<Object> values, PrintWriter out, boolean isInteractive, boolean[] alignRights) {
        Profiler.startProfile(Profiler.FAST, SQLUtility.class, "printTable(Object[],Collection<Object>,PrintWriter,boolean,boolean[])", null);
        try {
