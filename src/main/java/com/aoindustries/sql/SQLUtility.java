...
public class SQLUtility {
	...
	public static int getMillis(String decimal) {
		...
		if(decimal.indexOf('.')==-1) decimal += ".000";
		else if(decimal.charAt(decimal.length()-1)=='.') decimal += "000";
		else if(decimal.length()>=2 && decimal.charAt(decimal.length()-2)=='.') decimal += "00";
		else if(decimal.length()>=3 && decimal.charAt(decimal.length()-3)=='.') decimal += '0';
	...
	public static int getPennies(String decimal) {
		...
		if(decimal.indexOf('.')==-1) decimal += ".00";
		else if(decimal.charAt(decimal.length()-1)=='.') decimal += "00";
		else if(decimal.length()>=2 && decimal.charAt(decimal.length()-2)=='.') decimal += '0';
