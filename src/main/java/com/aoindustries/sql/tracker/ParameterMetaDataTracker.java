 ...
 */
public class ParameterMetaDataTracker extends ParameterMetaDataWrapper implements IParameterMetaDataTracker {

	public ParameterMetaDataTracker(ConnectionTracker connectionTracker, ParameterMetaData wrapped) {
