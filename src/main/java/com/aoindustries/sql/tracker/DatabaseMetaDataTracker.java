 ...
 */
public class DatabaseMetaDataTracker extends DatabaseMetaDataWrapper implements IDatabaseMetaDataTracker {

	public DatabaseMetaDataTracker(ConnectionTracker connectionTracker, DatabaseMetaData wrapped) {
	...
	public void close() throws SQLException {
		...
		t0 = ConnectionTracker.clearCloseAndCatch(t0, trackedResultSets);
		try {
			super.close();
		} catch(Throwable t) {
