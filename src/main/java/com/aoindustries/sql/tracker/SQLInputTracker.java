 ...
 */
public class SQLInputTracker extends SQLInputWrapper implements ISQLInputTracker {

	public SQLInputTracker(ConnectionTracker connectionTracker, SQLInput wrapped) {
