...
public class FailFastArray extends ArrayWrapper {

	public FailFastArray(FailFastConnection failFastConnection, FailFastStatement failFastStmt, Array wrapped) {
	...
	@Override
	public FailFastResultSet getResultSet(Map<String,Class<?>> map) throws SQLException {
		FailFastConnection ffConn = getConnectionWrapper();
		ffConn.failFastSQLException();
		try {
			return (FailFastResultSet)super.getResultSet(map);
		} catch(Throwable t) {
			ffConn.addFailFastCause(t);
			throw Throwables.wrap(t, SQLException.class, FailFastSQLException::new);
		}
	...
	@Override
	public FailFastResultSet getResultSet(long index, int count) throws SQLException {
		FailFastConnection ffConn = getConnectionWrapper();
		ffConn.failFastSQLException();
		try {
			return (FailFastResultSet)super.getResultSet(index, count);
		} catch(Throwable t) {
			ffConn.addFailFastCause(t);
			throw Throwables.wrap(t, SQLException.class, FailFastSQLException::new);
		}
	...
	@Override
	public FailFastResultSet getResultSet(long index, int count, Map<String,Class<?>> map) throws SQLException {
		FailFastConnection ffConn = getConnectionWrapper();
		ffConn.failFastSQLException();
		try {
			return (FailFastResultSet)super.getResultSet(index, count, map);
		} catch(Throwable t) {
			ffConn.addFailFastCause(t);
			throw Throwables.wrap(t, SQLException.class, FailFastSQLException::new);
		}
