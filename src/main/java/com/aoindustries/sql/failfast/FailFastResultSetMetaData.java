...
public class FailFastResultSetMetaData extends ResultSetMetaDataWrapper {

	public FailFastResultSetMetaData(FailFastConnection failFastConnection, ResultSetMetaData wrapped) {
