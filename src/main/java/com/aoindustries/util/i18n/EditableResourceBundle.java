...
abstract public class EditableResourceBundle extends ModifiablePropertiesResourceBundle implements Comparable<EditableResourceBundle> {
	...
	public static class ThreadSettings {
		 ...
		 *          sequences, map, and lookup context.
		 *
		 * @see  #setSettings(com.aoindustries.util.i18n.EditableResourceBundle.ThreadSettings.Mode, boolean)
		 */
	...
	/**
	 * Gets the current settings for the current thread or {@code null} if none set.
	 */
	...
	public static void removeThreadSettings() {
		currentThreadSettings.set(null);
