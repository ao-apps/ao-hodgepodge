 ...
 * Copyright (C) 2009, 2010, 2011, 2013, 2016, 2019, 2020, 2021, 2022, 2024, 2025  AO Industries, Inc.
...
public abstract class ModifiablePropertiesResourceBundle extends ModifiableResourceBundle {
  ...
  public static final Comparator<Object> PROPERTIES_KEY_COMPARATOR = new Comparator<>() {
  ...
  private void saveProperties() {
    ...
    try {
      ...
      try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
        ...
        // TODO: Java 9: Support UTF-8 properties files via reader/writer
        writer.store(
