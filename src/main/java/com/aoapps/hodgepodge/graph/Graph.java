 ...
 */
public interface Graph<V, E extends Edge<V>, Ex extends Throwable> extends MultiGraph<V, E, Ex> {

  /**
   * {@inheritDoc}
   *
   * <p>A graph only allows unique combinations of from and to vertices.</p>
   */
  @Override
