 ...
 * SortAlgorithm.java
 *
 * <p>Adapted from <a href="http://www.cs.ubc.ca/spider/harrison/Java/FastQSortAlgorithm.java.html">Denis Ahrens' FastQSortAlgorithm</a>,
 * which was derived from Sun's example QSortAlgorithm.</p>
 *
 * <p>2003-11-06 - Dan Armstrong - To avoid worst-case scenarios, if the quickSort recursion depth exceeds <code>(int)(10*Math.log(list.size()))</code>,
 *                              the algorithm will quit and a {@link HeapSort} will be performed.</p>
 *
...
public final class FastQSort extends BaseComparisonSortAlgorithm<Object> {
   ...
   *
   * <p>If you think of a one dimensional array as going from
   * the lowest index on the left to the highest index on the right
   * then the parameters to this function are lowest index or
   * left and highest index or right. The first time you call
   * this function it will be with the parameters 0, a.length - 1.</p>
   *
  ...
  private static <T> boolean quickSort(List<T> list, int l, int r, Comparator<? super T> comparator, SortStatistics stats, int currentRecursion, int maxRecursion) {
    ...
    if ((r - l) > M) {
      ...
      if (!quickSort(list, l, j, comparator, stats, newRecursion, maxRecursion)) {
        return false;
      }
      if (stats != null) {
  ...
  private static <T> boolean quickSort(T[] array, int l, int r, Comparator<? super T> comparator, SortStatistics stats, int currentRecursion, int maxRecursion) {
    ...
    if ((r - l) > M) {
      ...
      if (!quickSort(array, l, j, comparator, stats, newRecursion, maxRecursion)) {
        return false;
      }
      if (stats != null) {
        stats.sortUnrecursing();
